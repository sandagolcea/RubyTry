...
class WeaponsControllerTest < ActionController::TestCase
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post :create, weapon: { name: @weapon.name, strength: @weapon.strength, zombie_id: @weapon.zombie_id }
    end
  ...
  test "should update weapon" do
    patch :update, id: @weapon, weapon: { name: @weapon.name, strength: @weapon.strength, zombie_id: @weapon.zombie_id }
    assert_redirected_to weapon_path(assigns(:weapon))
  end
